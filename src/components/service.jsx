            ...
            <Carousel indicators={false}>
                ...
                /> */}
                    <div className='row p-5 mt-5 mb-5' style={{ backgroundColor: '#886b3c' }}>
                        ...
                        <div className='col-md-4 mb-3 d-flex justify-content-center align-items-center'>
                            <div className='row' style={{ color: '#CFCDCD9C', textAlign: 'left' }}>
                                <p>Brand messaging</p>
                                <p>Naming</p>
                                <p>Logo Design</p>
                                <p>Visual Identity</p>
                ...
                /> */}
                    <div className='row p-5 mt-5 mb-5' style={{ backgroundColor: '#886b3c' }}>
                        <div className='col-md-4 mb-3 d-flex justify-content-center align-items-center' style={{ flexDirection: 'column', textAlign: 'left' }}>
                            <p style={{ textAlign: 'left', color: 'white' }}>[WE TAKE CARE ABOUT]</p>
                            <p className='text-white'>Team of experts is dedicated to delivering exceptional
                                results and helping you achieve your business goals.
                                From strategic brand development to targeted digital
                ...
                /> */}
                    <div className='row p-5 mt-5 mb-5' style={{ backgroundColor: '#886b3c' }}>
                        <div className='col-md-4 mb-3 d-flex justify-content-center align-items-center' style={{ flexDirection: 'column', textAlign: 'left' }}>
                            <p style={{ textAlign: 'left', color: 'white' }}>[WE TAKE CARE ABOUT]</p>
                            <p className='text-white'>Digital marketing encompasses a wide range of strategies and techniques used to promote products, services, or brands through digital channels.<br></br><br></br> </p>
                        </div>
                        <div className='col-md-4 mb-3 d-flex justify-content-center align-items-center'>
                            <div className='row' style={{ textAlign: 'left' }}>
